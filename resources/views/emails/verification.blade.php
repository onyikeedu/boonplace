                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                        <tr>
                                            <td class="p30-15-0" style="padding: 40px 30px 0px 30px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        ...
                                                        <th class="column" width="120" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <!--<td class="text-header right" style="color:#000000; font-family:'Fira Mono', Arial,sans-serif; font-size:12px; line-height:16px; text-align:right;"><a href="{{ env('APP_URL') }}" target="_blank" class="link" style="color:#FCBB45; text-decoration:none;"><span class="link" style="color:#FCBB45; text-decoration:none;">{{ env('APP_NAME') }}</span></a></td>-->
                                                                </tr>
                                                            </table>
                                                        </th>
                                                    </tr>
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="separator" style="padding-top: 40px; border-bottom:4px solid #A87C2E; font-size:0pt; line-height:0pt;">&nbsp;</td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td class="p30-15" style="padding: 70px 30px 70px 30px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    @if(!empty( $array['link']))
                                                    <tr>
                                                        <td class="h5 center blue pb30" style="font-family:'Ubuntu', Arial,sans-serif; font-size:20px; line-height:26px; text-align:center; color:#1B1B28; padding-bottom:30px;">
                                                            <a href="{{ $array['link'] }}" style="background: #FCBB45;padding: 0.9rem 2rem;font-size: 0.875rem;color:#fff;border-radius: 15px;" target="_blank">{{ translate("Click Here") }}</a>
                                                        </td>
                                                    </tr>
                                                    @endif
                                                </table>
