    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-lg-6 text-center text-lg-left">
                <h1 class="fw-600 h4">{{ translate('Register your event')}}</h1>
            </div>
            <div class="col-lg-6">
                <ul class="breadcrumb bg-transparent p-0 justify-content-center justify-content-lg-end">
                    ...
                    <li class="text-dark fw-600 breadcrumb-item">
                        <a class="text-reset" href="{{ route('shops.create') }}">"{{ translate('Register your event')}}"</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-xxl-5 col-xl-6 col-md-8 mx-auto">
                <form id="shop" class="" action="{{ route('shops.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="bg-white rounded shadow-sm mb-4">
                        ...
                        <div class="p-3">
                            <div class="form-group">
                                <label>{{ translate('Username/Event ID')}} <span class="text-primary">*</span></label>
                                <input type="text" class="form-control" placeholder="{{ translate('Username/Nickname')}}" name="name" required>
                            </div>
                            <!-- <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>{{ translate('Delivery Address')}} <span class="text-primary">*</span></label>
                                <input type="text" class="form-control mb-3" placeholder="{{ translate('Address')}}" name="address" required>
                            </div>
                            <div class="form-group">
                                <label>{{ translate('Date of Event')}} <span class="text-primary">*</span></label>
                                <input type="date" min="2021-08-01" max="2050-12-31" class="form-control" placeholder="{{ translate('Date of Event')}}" name="date_of_event" required>
                            </div>
                        </div>
                    </div>
