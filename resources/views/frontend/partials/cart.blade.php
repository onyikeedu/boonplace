...
<a href="javascript:void(0)" class="d-flex align-items-center text-reset h-100" data-toggle="dropdown" data-display="static">
    <i class="la la-shopping-cart la-2x opacity-80" style="background-color:#FCBB45; border:solid; border-radius: 50px;"></i>
    <span class="flex-grow-1 ml-1">
        ...
        @endif
        <span class="nav-box-text d-none d-xl-block opacity-70" style="color: #FCBB45">{{translate('Cart')}}</span>
    </span>
</a>
