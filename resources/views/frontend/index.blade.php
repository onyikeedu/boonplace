...
<section class="discover" style="background-color:#111723; padding: 100px 2px 150px 2px">
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NQ8HW4X"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->
    <div class="container-fluid">
         <div>
            <h1 style="color: #fff">
                <span style="color:#FCBB45">Gifting</span>, the purest way of showing love. 
            </h1>
            <h4 style="color: #fff">
                Send and receive the perfect gift all the time with <span style="color:#FCBB45">Boonplace</span>.
            </h4>
            <br>
            <br>
            <p style="color:#fff">Get started by creating a wishlist</p>
        </div>
        <br>
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <a href="https://boonplace.com/shops/create" class="shop-btn">Create Wishlist</a>
            </div>
        </div>
    </div>
</section>
...
<body>
                ...
                <div id="effect" class="effects clearfix">
                    <div class="col-md-4 left nopadding">
                        <div class="left-box-1">
                            <div class="img">
                                <img src="{{url('/public/assets/img/birthday.jpg')}}" alt="event 1">
                                <div class="front">
                                    <a href="https://boonplace.com/shops/create" class="expand">birthday</a>
                        ...
                        <div class="left-box-2 box">
                            <div class="img">
                                <img src="{{url('/public/assets/img/wedding-cake.jpg')}}" alt="event 2">
                                <div class="front">
                                    <a href="https://boonplace.com/shops/create" class="expand">cakes</a>
                                    <a class="close-overlay hidden">x</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="left-box-btm box">
                            <div class="img">
                                <img src="{{url('/public/assets/img/wedding.jpg')}}" alt="event 3">
                                <div class="front">
                                    <a href="https://boonplace.com/shops/create" class="expand">wedding</a>
                                    <a class="close-overlay hidden">x</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 mid nopadding">
                        <div class="mid-box-1 box">
                            <div class="img">
                                <img src="{{url('/public/assets/img/gift.jpg')}}" alt="event 4">
                                <div class="front">
                                    <a href="https://boonplace.com/shops/create" class="expand">gift</a>
                                    <a class="close-overlay hidden">x</a>
                                </div>
                            </div>
                        </div>
                        <div class="mid-box-2 box">
                            <div class="img">
                                <img src="{{url('/public/assets/img/couple.jpg')}}" alt="event 5">
                                <div class="front">
                                    <a href="https://boonplace.com/shops/create" class="expand">couples</a>
                                    <a class="close-overlay hidden">x</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 right nopadding">
                        <div class="right-box-1 box">
                            <div class="img">
                                <img src="{{url('/public/assets/img/birthday-kid.jpg')}}" alt="event 6">
                                <div class="front">
                                    <a href="https://boonplace.com/shops/create" class="expand">event 6</a>
                                    <a class="close-overlay hidden">x</a>
                                </div>
                            </div>
                        </div>
                        <div class="right-box-2 box">
                            <div class="img">
                                <img src="{{url('/public/assets/img/graduation.jpg')}}" alt="event 7">
                                <div class="front">
                                    <a href="https://boonplace.com/shops/create" class="expand">graduation</a>
                                    <a class="close-overlay hidden">x</a>
                                </div>
                            </div>
                        </div>
                        <div class="right-box-3 box">
                            <div class="img">
                                <img src="{{url('/public/assets/img/gift2.jpg')}}" alt="event 8">
                                <div class="front">
                                    <a href="https://boonplace.com/shops/create" class="expand">gifting</a>
                                    <a class="close-overlay hidden">x</a>
                                </div>
                            </div>
                        </div>
    ...
    <!--<section class="discover" style="background-color:#111723">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <a href="https://boonplace.com/shops/create" class="shop-btn">Create Wishlist</a>
