                        ...
                        @else
                            <div class="shadow-sm bg-white p-4 rounded mb-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group has-feedback">
                                            <label class="control-label">{{ translate('Postal code (optional)')}}</label>
                                            <input type="text" class="form-control" placeholder="{{ translate('Postal code(Optional)')}}" name="postal_code">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group has-feedback">
            ...
            <form class="form-default" role="form" action="{{ route('addresses.store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="p-3">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <label>{{ translate('Postal code(Optional)')}}</label>
                            </div>
                            <div class="col-md-10">
