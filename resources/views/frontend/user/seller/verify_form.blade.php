...
@section('panel_content')
            ...
            <div class="col-md-6">
                <div class="float-md-right">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a href="{{ route('shops.index') }}">{{ translate('Profile settings')}}</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <form class="" action="{{ route('shop.verify.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-box bg-white mt-4">
            <div class="form-box-title px-3 py-2" style="font-weight: 700">
        ...
        <small class="text-muted">{{ translate('*This form is only for verification purposes and will not appear on your profile. Once the info is verified, your wishlist will be updated for you to manage') }}</small>
