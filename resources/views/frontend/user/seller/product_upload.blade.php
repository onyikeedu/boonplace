...
<form class="" action="{{route('products.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
    <div class="row gutters-5">
        ...
        <div class="col-lg-4">
                ...
                <div class="card-body">
                    ...
                    <div class="flat_rate_shipping_div" style="display: none">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="500" step="0.01"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group mb-3">
                        ...
                        <input type="number" name="low_stock_quantity" value="1" min="0" step="1" class="form-control" readonly>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{translate('Estimated Shipping Time')}}</h5>
                </div>
                <div class="card-body">
                    <div class="form-group mb-3">
                        <label for="name">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control" name="est_shipping_days" min="1" step="1"
                                placeholder="Shipping Days" value="3" readonly>
                            <div class="input-group-prepend">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{translate('Tax & Commission')}}</h5>
                </div>
                <div class="card-body">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <input type="number" lang="en" min="0" value="5" step="0.01"
                                placeholder="{{ translate('Tax') }}" name="tax[]" class="form-control" readonly>
                        </div>
                        <div class="form-group col-md-6">
                            <select class="form-control aiz-selectpicker" name="tax_type[]">
                                <option value="percent" checked>{{translate('Percent')}}</option>
                                <!--<option value="amount">{{translate('Flat')}}</option>-->
                            </select>
                        </div>
                    </div>
