...
@section('panel_content')
    ...
    <form action="{{ route('seller.profile.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label class="col-md-2 col-form-label">{{ translate('Change Password') }}</label>
                    <div class="col-md-10">
                    ...
                    @foreach (Auth::user()->addresses as $key => $address)
                        <div class="col-lg-6">
                            <div class="border p-3 pr-5 rounded mb-3 position-relative">
                                ...
                                <div>
                                    <span class="w-50 fw-600">{{ translate('Phone Number') }}:</span>
    ...
    <form action="{{ route('user.change.email') }}" method="POST">
        ...
        <div class="card">
          <div class="card-header">
              <h5 class="mb-0 h6">{{ translate('Change your e-mail')}}</h5>
          </div>
          <div class="card-body">
              <div class="row">
                  <div class="col-md-2">
                      <label>{{ translate('Your E-mail') }}</label>
                  </div>
                  <div class="col-md-10">
                        ...
                        <div class="input-group-append">
                           <button type="button" class="btn btn-outline-secondary new-email-verification">
                               <span class="d-none loading">
                                   <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>{{ translate('Sending E-mail...') }}
                               </span>
                      ...
                      <div class="form-group mb-0 text-right">
                          <button type="submit" class="btn btn-primary">{{translate('Update E-mail')}}</button>
                      </div>
                  </div>
              </div>
          </div>
                ...
                <div class="modal-body">
                    <div class="p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control mb-3" placeholder="{{ translate('+234')}}" name="phone" value="" required>
                            </div>
                        </div>
