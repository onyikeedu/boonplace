                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <input type="text" class="form-control" name="unit"
                                placeholder="{{ translate('Unit (e.g. Kg, Pcs, unit etc)') }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <label class="aiz-switch aiz-switch-success mb-0">
                            ...
                            'flat_rate') checked @endif readonly>
                            <span></span>
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="input-group">
                        <input type="number" class="form-control" name="est_shipping_days"
                            value="{{ $product->est_shipping_days }}" min="1" step="1" placeholder="Shipping Days" readonly>
                        <div class="input-group-prepend">
