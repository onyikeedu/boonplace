    ...
    <div class="row">
      ...
      <div class="col-md-4">
          ...
          <div class="bg-white mt-4 p-4 text-center">
              <div class="h5 fw-600">{{ translate('Profile')}}</div>
              <p>{{ translate('Manage & organize your profile')}}</p>
              <a href="{{ route('shops.index') }}" class="btn btn-soft-primary">{{ translate('Go to setting')}}</a>
          </div>
          <div class="bg-white mt-4 p-4 text-center">
              <div class="h5 fw-600">{{ translate('Payment')}}</div>
              <p>{{ translate('Configure and update your payment details')}}</p>
              <a href="{{ route('profile') }}" class="btn btn-soft-primary">{{ translate('Configure Now')}}</a>
          </div>
          <!--<div class="discover" style="background-color:#111723">
             <div class="container-fluid">
                <div class="row">
                    <div class="col-md-4 col-md-offset-4">
                        <a href="https://www.facebook.com/sharer/sharer.php?u=boonplace.com" class="shop-btn">Register with us</a>
                    </div>
                </div>
            </div>
          </div>-->
