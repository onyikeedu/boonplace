	...
	<div class="modal-dialog modal-adaptive" role="document">
		<div class="modal-content h-100">
			<div class="modal-header pb-0 bg-light">
				<div class="uppy-modal-nav">
					<ul class="nav nav-tabs border-0">
						<li class="nav-item">
							<a class="nav-link active font-weight-medium text-dark" data-toggle="tab" href="#aiz-select-file">{{ translate('Photo Gallery') }}</a>
						</li>
						<li class="nav-item">
							<a class="nav-link font-weight-medium text-dark" data-toggle="tab" href="#aiz-upload-new" style="color: #FF0000">{{ translate('+ Add New Photo to Gallery') }}</a>
						</li>
					</ul>
				</div>
						...
						<div class="aiz-uploader-all clearfix c-scrollbar-light">
							<div class="align-items-center d-flex h-100 justify-content-center w-100">
								<div class="text-center">
									...
									<h3>{{ translate('click on "Add New Photo"') }} </h3>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="modal-footer justify-content-between bg-light">
				...
				<button type="button" class="btn btn-sm btn-primary" data-toggle="aizUploaderAddSelected">{{ translate('Use Selected Photo') }}</button>
			</div>
		</div>
	</div>
</div>
