...
Route::get('/my-wishlist/{slug}', 'HomeController@shop')->name('shop.visit');
Route::get('/my-wishlist/{slug}/{type}', 'HomeController@filter_shop')->name('shop.visit.type');
...
Route::group(['prefix' => 'seller', 'middleware' => ['seller', 'verified', 'user']], function() {
    ...
    Route::get('/my-wishlist/apply_for_verification', 'ShopController@verify_form')->name('shop.verify');
